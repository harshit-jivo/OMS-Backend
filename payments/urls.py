...
urlpatterns = [
    ...
    path('cash-accounts/', views.CashAccountListView.as_view(),
         name='payment-cash-accounts'),

    # Approval — payments' own, replacing the generic /api/approvals/ routes.
    path('approvals/queue/', views.PaymentApprovalQueueView.as_view(),
         name='payment-approval-queue'),
    path('receipts/<int:pk>/approve/',
         views.PaymentReceiptApproveView.as_view(), name='payment-receipt-approve'),
    path('receipts/<int:pk>/reject/',
         views.PaymentReceiptRejectView.as_view(), name='payment-receipt-reject'),
    path('receipts/<int:pk>/cancel/',
         views.PaymentReceiptCancelView.as_view(), name='payment-receipt-cancel'),
    path('deposits/<int:pk>/approve/',
         views.BankDepositApproveView.as_view(), name='payment-deposit-approve'),
    path('deposits/<int:pk>/reject/',
         views.BankDepositRejectView.as_view(), name='payment-deposit-reject'),
    path('deposits/<int:pk>/cancel/',
         views.BankDepositCancelView.as_view(), name='payment-deposit-cancel'),
