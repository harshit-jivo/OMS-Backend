...
urlpatterns=[
    ...
    path('<int:order_id>/delete-draft/', DeleteDraftOrderView.as_view(), name='delete-draft'),
    ...
    path("api/ai-order-summary/", AiOrderSummaryView.as_view(), name="ai-order-summary"),
