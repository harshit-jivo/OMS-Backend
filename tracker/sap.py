"""Fast SAP vendor lookup for the invoice entry form.

Reads the vendor (supplier) master directly from HANA — NOT via the Service
Layer, which is slower — reusing the shared HANAConnection. The result is
cached for a few minutes so the entry form's searchable dropdown stays snappy.
...
VENDOR_CACHE_KEY = 'tracker_sap_vendors'
